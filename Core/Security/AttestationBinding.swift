...
/// imzalamaz. TLS pinning kaldırıldığından (Cloudflare/OWASP kararı) araya giren biri gövdedeki
/// card_id'yi imzadan sonra değiştirebilir. card_id'yi clientDataHash'e
/// katınca assertion yalnız bu tam card_id için geçerli olur.
///
/// Sözleşme — sunucu ve Android istemcisi (`util/AttestationBinding.kt`) ile BİREBİR aynı:
...
///
/// Golden vector üç tarafta aynı: iOS Stage6SelfTest ↔ sunucu testi ↔ Android AttestationBindingTest.kt.
