...
/// cihazda dev env butonuyla çalışır.
...
enum Stage3SelfTest {
    ...
    static func runAll() -> [SelfTestResult] {
        ...
        r.append(check("isSmileNeutral: 0.2 nötr, 0.5 nötr DEĞİL") {
            (LivenessGestureDetector.isSmileNeutral(0.2) && !LivenessGestureDetector.isSmileNeutral(0.5), "ok")
        })
